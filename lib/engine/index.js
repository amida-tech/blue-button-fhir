...
var enginePrototype = {
    ...
    run: function (input, template) {
        var that = this;
        var b = that.evaluateCondition(input, template);
        if (!b) {
            return null;
        }
