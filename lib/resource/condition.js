...
exports.toModel = function (app, resource, callback) {
    var problem = {};
    var resourceCode = resource.body && resource.body.code && resource.body.code.coding;
    if (resourceCode) {
        var code = {};
    ...
    var onsetDate = resource.body.onsetDate;
    if (onsetDate) {
    ...
    var abatementDate = resource.body.abatementDate;
    if (abatementDate) {
    ...
    if (resource.body.abatementBoolean) {
        result.status = {
            name: "Resolved"
        };
    }
