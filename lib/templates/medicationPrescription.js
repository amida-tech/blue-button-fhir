...
exports.template = {
    ...
    content: {
        ...
        'date_time.low': {
            ...
            dataKey: 'dateWritten',
            existsWhen: predicate.hasNoProperty('dosageInstruction.0.scheduledDateTime')
        },
        'date_time.point': {
            value: value.datetime,
            dataKey: 'dateWritten',
            existsWhen: predicate.hasProperty('dosageInstruction.0.scheduledDateTime')
        },
        'product.product': {
            value: value.concept,
        ...
        'administration.interval': {
            ...
            existsWhen: predicate.hasNoProperty('dosageInstruction.0.scheduledTiming.repeat.when')
        },
        'administration.interval.event': {
            value: value.codeToValueSet('scheduleWhen'),
            dataKey: jp('dosageInstruction[0].scheduledTiming.repeat.when')
        },
        'precondition.value': {
            value: value.concept,
        ...
        'date_time.high': {
            value: value.datetime,
            dataKey: [jp('dosageInstruction[0].scheduledTiming.repeat.bounds.end'), jp('dosageInstruction[0].scheduledPeriod.end')]
        },
        sig: {
            dataKey: 'text.div'
        }
